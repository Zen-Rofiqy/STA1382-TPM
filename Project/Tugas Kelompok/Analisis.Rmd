---
title: "Tugas Akhir Teknik Pembelajaran Mesin"
...
![](images/Angga_Kemeja Hitam-01.png){width="176"}

[**Email:**]{style="color: #083c5c"} [zenr.prog\@gmail.com](zenr.prog@gmail.com)

[**Github:**]{style="color: #083c5c"} <https://github.com/Zen-Rofiqy>

[**Rpubs:**]{style="color: #083c5c"} <https://rpubs.com/ZenR_Prog/>

[**Kaggle:**]{style="color: #083c5c"} <https://www.kaggle.com/zenrofiqy>
...
install_load("ggplot2","dplyr","DT","cowplot","factoextra","mclust","rio",
...
Data untuk analais bisa di dapatkan di [data.github](https://github.com/Zen-Rofiqy/STA1382-TPM/blob/main/Project/Tugas%20Kelompok/Data.csv){.uri} dan data kode provinsi ada di [kode.github](https://github.com/Zen-Rofiqy/STA1382-TPM/blob/main/Project/Tugas%20Kelompok/Kode%20Provinsi.csv){.uri}
...
# Eksport
ggsave("Kmeans 2D 2.png", chart, path = export.chart,
        dpi = 300, height = 5, width = 7)
```
