...
library(NbClust)
library("factoextra")
nb <- NbClust(data = dt, distance = "euclidean", method="kmeans")
```

Untuk hubert statistic dan dindex, jumlah cluster optimal yang disarankan adalah 4.
